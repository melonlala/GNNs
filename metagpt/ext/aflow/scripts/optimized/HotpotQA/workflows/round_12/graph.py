...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        # Use self-ensemble to select the best solution from the generated options
        final_solution = await self.sc_ensemble(solutions=[sol['answer'] for sol in multiple_solutions])
