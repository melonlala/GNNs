...
class ModelsConfig(YamlModel):
    ...
    # @classmethod
    # def from_dict(cls, final: dict):
    #     """
    #     Loads configuration from a dictionary.

    #     Args:
    #         final (dict): Dictionary of configurations.

    #     Returns:
    #         ModelsConfig: ModelsConfig object.
    #     """
    #     models_dict = {'llm': LLMConfig(**final['llm'])}

    #     # 创建 ModelsConfig 实例
    #     return cls(models=models_dict)
    ...
    def default(cls):
        ...
        # return ModelsConfig.from_dict(final)
