...
def parse_args():
    ...
    parser.add_argument("--dataset_path", type=str, default="metagpt/ext/aflow/data/math_validate.jsonl")
    parser.add_argument("--results_dir", type=str, default="experiments/MATH/workflows_latest")
    parser.add_argument("--root_dir", type=str, default="experiments/MATH/filter_task")
...
def get_filtered_dataset_file(dataset_file, filtered_questions_path, filtered_dataset_path):
    ...
    print(f"Number of filtered data: {len(dataset)}")
