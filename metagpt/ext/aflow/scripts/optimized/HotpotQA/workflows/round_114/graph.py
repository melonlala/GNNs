...
import metagpt.ext.aflow.scripts.optimized.HotpotQA.workflows.round_114.prompt as prompt_custom
...
class Workflow: 
    ...
    async def __call__(self, problem: str): 
        ...
        # Invoke feedback mechanism to improve the preliminary answer 
        feedback_response = await self.custom(input=preliminary_response['response'], instruction=prompt_custom.FEEDBACK_PROMPT) 
        preliminary_response['response'] += " " + feedback_response['response'] 
