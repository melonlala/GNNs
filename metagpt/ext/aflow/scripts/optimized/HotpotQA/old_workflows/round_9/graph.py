...
import metagpt.ext.aflow.scripts.optimized.HotpotQA.workflows.round_9.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        review_response = await self.custom(input="Please evaluate the following answers for clarity and conciseness, and suggest the best one: " + " ".join(resp['answer'] for resp in responses + alternative_responses), instruction=prompt_custom.REVIEW_PROMPT)
