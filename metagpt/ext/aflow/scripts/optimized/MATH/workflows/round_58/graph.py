...
import metagpt.ext.aflow.scripts.optimized.MATH.workflows.round_58.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        if verification_result['output'] == "True":  # Assuming the output is a boolean string
