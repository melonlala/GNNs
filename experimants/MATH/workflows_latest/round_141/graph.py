...
import metagpt.ext.aflow.scripts.optimized.MATH.workflows.round_141.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        # Adding ensemble for multiple solutions
        ensemble_response = await self.ensemble(solutions=[solution['response'], validation_result['output']], problem=problem)
