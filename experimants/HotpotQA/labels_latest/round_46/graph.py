...
import metagpt.ext.aflow.scripts.optimized.HotpotQA.workflows.round_46.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        # Self-ask mechanism to deepen the response
        self_ask_response = await self.custom(input=problem + " " + preliminary_response['response'], instruction=prompt_custom.SELF_ASK_PROMPT)
