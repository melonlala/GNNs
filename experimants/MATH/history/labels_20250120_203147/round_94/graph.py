...
import metagpt.ext.aflow.scripts.optimized.MATH.workflows.round_94.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        review_instruction = f"Review the following solution for correctness and provide feedback: {solution['response']}"
