...
import metagpt.ext.aflow.scripts.optimized.HotpotQA.workflows.round_57.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        # Check if the preliminary response is relevant
        if not any(keyword in preliminary_response['response'] for keyword in ['wife', 'author', 'battle']):  # Keywords related to the question context
