...
import metagpt.ext.aflow.scripts.optimized.HotpotQA.workflows.round_75.prompt as prompt_custom
...
class Workflow: 
    ...
    async def __call__(self, problem: str): 
        ...
        # Clarification step if the preliminary response lacks detail
