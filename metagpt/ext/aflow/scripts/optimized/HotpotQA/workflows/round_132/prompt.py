...
FOLLOW_UP_PROMPT = """
Generate follow-up questions based on the following answer.
Answer: {answer}
"""

CLARIFYING_QUESTIONS_PROMPT = """
Generate clarifying questions based on the following problem statement to enhance understanding.
