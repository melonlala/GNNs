...
import metagpt.ext.aflow.scripts.optimized.HotpotQA.workflows.round_5.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        review_solution = await self.custom(input=final_solution['response'], instruction="Please review this answer for accuracy and completeness.")
