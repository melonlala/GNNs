...
import metagpt.ext.aflow.scripts.optimized.HotpotQA.workflows.round_56.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        # Generate a detailed preliminary answer
        preliminary_response = await self.answer_generate(input=problem + f" Context: {context_response['response']}")
        ...
        # Use self-consistency to select the best solution through majority voting
