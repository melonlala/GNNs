...
import metagpt.ext.aflow.scripts.optimized.MATH.workflows.round_44.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        return solution['response'], verification_result['output'], self.llm.cost_manager.total_cost
