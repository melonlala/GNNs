...
from metagpt.ext.aflow.benchmark.mmlu import MMLUBenchmark
...
class Evaluator:
    ...
    async def graph_evaluate(
        ...
        gnn_optimize = None, gnn_model = None, encoder = None
        ...
        return await benchmark.run_evaluation(configured_graph, va_list, gnn_optimize, gnn_model, encoder)
