...
import metagpt.ext.aflow.scripts.optimized.HotpotQA.workflows.round_40.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        ensemble_response = await self.sc_ensemble(solutions=[ans['answer'] for ans in final_reviewed_answers])
