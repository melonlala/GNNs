...
def parse_args():
    ...
    parser.add_argument("--workflow_dir", type=str, nargs="?",default="metagpt/ext/aflow/scripts/optimized/MMLU/workflows", help="Workflow directory")
    parser.add_argument("--labels_dir", type=str, nargs="?",default="experiments/MMLU/gnn_actual_labels", help="Labels directory")
