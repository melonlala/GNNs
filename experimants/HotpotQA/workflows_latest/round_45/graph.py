...
import metagpt.ext.aflow.scripts.optimized.HotpotQA.workflows.round_45.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        if not preliminary_response['response'] or len(preliminary_response['response']) < 20:  # Check for relevance and minimum length
            return "Preliminary response is not relevant or too short", self.llm.cost_manager.total_cost
