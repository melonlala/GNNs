...
import metagpt.ext.aflow.scripts.optimized.HotpotQA.workflows.round_23.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        review_response = await self.custom(input="Please evaluate the following answers for clarity and conciseness, suggesting improvements: " + " ".join(resp['answer'] for resp in all_responses), instruction=prompt_custom.REVIEW_PROMPT)
