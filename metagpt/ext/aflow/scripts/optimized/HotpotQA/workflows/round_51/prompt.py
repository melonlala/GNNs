...
Please extract key information from the following context response to aid in validation.
...
Please validate the following context response to ensure it is relevant and comprehensive.
