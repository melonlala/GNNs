...
import metagpt.ext.aflow.scripts.optimized.MATH.workflows.round_14.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        return solution['response'], self.llm.cost_manager.total_cost, verification_result['output']
