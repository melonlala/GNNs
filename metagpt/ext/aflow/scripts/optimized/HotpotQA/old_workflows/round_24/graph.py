...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        # Generate follow-up questions based on the original problem
        follow_up_questions = await self.custom(input=problem, instruction=prompt_custom.FOLLOW_UP_PROMPT)
        ...
        # Review the generated responses for quality and clarity, including scoring
        ...
        # Return the best response, follow-up questions, and the total cost
        return ensemble_response['response'], follow_up_questions['response'], self.llm.cost_manager.total_cost
