...
@PromptSetRegistry.register('hotpotqa')
class HotpotQAPromptSet(PromptSet):
    """
    HotpotQA prompt set.
    """
    @staticmethod
    ...
    def get_decision_role():
        return "You are the top question-answer expert and are good at analyzing and summarizing other people's opinions, finding errors and giving final answers."
    ...
    def get_constraint():
        ...
        You must give the correct answer to the question.
        Your response must be less than 10 words.
...
I will ask you a question and give you some background information.
...
"""
    ...
    def get_decision_constraint():
        ...
        I will ask you a question.
        You must give the correct answer to the question.
        Your response must be less than 10 words and as short as possible.
        I will give you some other people's answers and analysis.
        """
