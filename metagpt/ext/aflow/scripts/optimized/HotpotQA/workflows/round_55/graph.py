...
import metagpt.ext.aflow.scripts.optimized.HotpotQA.workflows.round_55.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        # Check confidence and generate clarification if needed
        if "not sure" in preliminary_response['response'] or "uncertain" in preliminary_response['response']:
