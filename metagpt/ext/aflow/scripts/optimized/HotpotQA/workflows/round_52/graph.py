...
import metagpt.ext.aflow.scripts.optimized.HotpotQA.workflows.round_52.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        # Check if the preliminary response is unclear and generate a clarification question if needed
