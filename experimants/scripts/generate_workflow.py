...
import os
# os.environ["HTTP_PROXY"] = "http://127.0.0.1:7836"
# os.environ["HTTPS_PROXY"] = "http://127.0.0.1:7836"
...
def parse_args():
    ...
    parser.add_argument("--initial_round", type=int, default=59, help="Initial round")
    ...
    parser.add_argument("--gnn_optimize", type=bool, default=True)
