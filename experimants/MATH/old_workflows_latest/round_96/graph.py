...
import metagpt.ext.aflow.scripts.optimized.MATH.workflows.round_96.prompt as prompt_custom
...
class Workflow:
    ...
    async def __call__(self, problem: str):
        ...
        review_response = await self.custom(input=ensemble_response['response'], instruction="Review and validate this solution.")
